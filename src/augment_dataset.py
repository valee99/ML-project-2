...
def save_augmented(transformed: dict, transform_name: str, image_path: str, label_path: str):
    ...
    for idx, annotation in enumerate(bboxes):
        ...
        transformed_labels.append(" ".join([str(transformed_class_labels[idx])] + str_annotation))
